					...
					<script type="text/javascript">
						...
						(function($) {
							...
							$(document).ready(function(){
								...
								$('body').on('click', '.share-link', share_action_listener);
								
							});
							
							function share_action_listener( event ) {
								...
								//Open Window
								OpenWindow( shareUrl, 'Share Article' );
				
							}
							
							function OpenWindow( windowURL, name, width, height ) {
							    ...
							    var win = window.open(windowURL, name, features_str);
							    win.focus();
							    return false;
							}
